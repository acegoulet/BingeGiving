...
<?php while (have_posts()) : the_post(); ?>
	...
	<section id="section-5" data-section="<?php echo sluggify(get_field('section_5_menu_label')); ?>" class="bg-white section-5 section-padding height-100">
		<div class="container">
			...
			<?php 
				...
				foreach($section_5_list as $section_5_list_item){
					echo '<div class="list-box border-blue text-center quicksand vert-center list-title fade-in-out-scroll grid_'.$pattern[$box_index].'">'.$section_5_list_item['list_item_text'].'</div>';
					$box_index++;
					if($box_index == 14){
						$box_index = 0;
					}
	...
	<section id="section-6" data-section="<?php echo sluggify(get_field('section_6_menu_label')); ?>" class="bg-grey-light section-6 section-padding height-100" style="background-image: url(<?php echo get_image_url(get_field('section_6_background_image'), 'full'); ?>);">
		<div class="container">
			...
			<div class="section-6-boxes">
				...
				?>
				<div class="clear"></div>
				<div class="section-6-title grid_12 fade-in-out-scroll-left"><h2 class="headline"><?php the_field('section_6_end_text'); ?></h2></div>
				<div class="clear"></div>
			</div>
		</div>
	</section>
