...
function theme_enqueue_styles() {
	wp_enqueue_style( 'parent-style', gsdu() . '/style.css', '', '1.0.18' );
...
function theme_scripts_enqueue() {
	...
	if(get_site_env() == 'staging' || get_site_env() == 'dev'){
		...
		if(is_front_page()){
			wp_enqueue_script('intro', gtdu(). '/js/site-scripts/intro.js', array('jquery', 'tweenmax', 'timelinelite'), '1.0.10', true);
		}
	}
	else {
		wp_enqueue_script('theme-scripts-min', gtdu(). '/js/script-min.js', array('jquery', 'slick', 'waypoints'), '1.0.10', true);
		if(is_front_page()){
			wp_enqueue_script('intro', gtdu(). '/js/intro-min.js', array('jquery', 'tweenmax', 'timelinelite'), '1.0.10', true);
		}
	}
}
