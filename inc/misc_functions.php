...
function theme_enqueue_styles() {
	wp_enqueue_style( 'parent-style', gsdu() . '/style.css', '', '1.0.16' );
...
function theme_scripts_enqueue() {
	...
	wp_enqueue_script('slick', gtdu(). '/js/vendor/slick.js', 'jquery', '1.6.0', true);
	wp_enqueue_script('waypoints', gtdu(). '/js/vendor/jquery.waypoints.min.js', 'jquery', '4.0.1', true);
	wp_enqueue_script('tweenmax', gtdu(). '/js/vendor/TweenMax.min.js', 'jquery', '1.19.1', true);
	wp_enqueue_script('timelinelite', gtdu(). '/js/vendor/TimelineLite.min.js', 'jquery', '1.19.1', true);
	wp_enqueue_script('ScrollToPlugin', gtdu(). '/js/vendor/ScrollToPlugin.min.js', 'jquery', '1.9.0', true);
	
	if(get_site_env() == 'staging' || get_site_env() == 'dev'){
		wp_enqueue_script('theme-scripts', gtdu(). '/js/site-scripts/site-scripts.js', array('jquery', 'slick', 'waypoints'), '1.0.10', true);
		if(is_front_page()){
			wp_enqueue_script('intro', gtdu(). '/js/site-scripts/intro.js', array('jquery', 'tweenmax', 'timelinelite', 'ScrollToPlugin'), '1.0.10', true);
		}
	}
	else {
		wp_enqueue_script('theme-scripts-min', gtdu(). '/js/script-min.js', array('jquery', 'slick', 'waypoints'), '1.0.10', true);
		if(is_front_page()){
			wp_enqueue_script('intro', gtdu(). '/js/intro-min.js', array('jquery', 'tweenmax', 'timelinelite', 'ScrollToPlugin'), '1.0.10', true);
		}
	}
}
...
function aceify_login_style() { ?>
	...
	<style type="text/css">
		...
		body.login div#login h1{
			background: url("<?php echo gsdu(); ?>/img/logo-white-trans.png") center no-repeat;
			width: 100%;
			height: 221px;
